...
{
    [shield release];
    [super dealloc]; //you must dealloc everytime you have a retain or copy attribute
}
...
- (void)update
{
    ...
    if (self.shield == nil && k.shieldPressed) {
        self.shield = [[[ASDrawable alloc] initWithImage: [NSImage imageNamed: @"shield"]] autorelease];
    }
    if (self.shield != nil && !k.shieldPressed) {
        self.shield = nil;
    }
